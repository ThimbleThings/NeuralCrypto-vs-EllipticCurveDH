...
public:
  ...
  OlsrState m_state;
  OlsrState m_state_save;
  uint8_t m_willingness;
  void Dump2 (void);
  void SaveNeighborTuple (const NeighborTuple &tuple);
  void SaveNeighborSet (void);
  bool CompareNeighborSet (void);
  bool CompareNeighborSet (int32_t in_num_equal);
  /// aur: Erweiterung iSig
